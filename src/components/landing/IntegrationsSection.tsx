...
import { ShoppingCart, BarChart3, Mail } from "lucide-react";
      ...
      >
        {integrations.map((int) => (
          <div key={int.name} className="flex flex-col items-center gap-3 group">
            <div className="w-20 h-20 rounded-2xl bg-card border border-border flex items-center justify-center group-hover:shadow-lg group-hover:border-accent/30 transition-all duration-300">
